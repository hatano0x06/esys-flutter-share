...
class Share {
  ...
  static void text(String title, String text, String mimeType, {Rect sharePositionOrigin,}) {
  ...
  static Future<void> file(
      String title, String name, List<int> bytes, String mimeType, {String text = '', Rect sharePositionOrigin,}) async {
    Map argsMap = <String, dynamic>{
      'title': '$title',
      'name': '$name',
      'mimeType': '$mimeType',
  ...
  static Future<void> files(
      String title, Map<String, List<int>> files, String mimeType, {String text = '', Rect sharePositionOrigin,}) async {
    Map argsMap = <String, dynamic>{
      'title': '$title',
